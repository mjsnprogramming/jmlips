...
const TREATMENTS: Treatment[] = [
  {
    ...
    category: 'Lips',
    desc: 'Subtelne podkreślenie kształtu i objętości z zachowaniem naturalnych proporcji.',
    details: 'Miękki, nawilżony efekt bez przerysowania. Zabieg wykonywany z naciskiem na harmonię rysów twarzy i naturalny rezultat.',
    duration: '45–60 min',
  ...
  },
  {
    ...
    desc: 'Odświeżenie czerwieni wargowej, poprawa nawilżenia i gładkości ust.',
    details: 'Naturalny połysk, komfort oraz poprawa jakości ust bez zwiększania objętości.',
    duration: '30–45 min',
    effect: 'Fresh lips',
  ...
  },
  {
    ...
    category: 'Correction',
    desc: 'Bezpieczne rozpuszczanie niepożądanego lub przeterminowanego wypełniacza.',
    details: 'Przywrócenie naturalnych rysów oraz możliwość przygotowania do ponownego modelowania.',
    duration: '30 min',
  ...
  },
  {
    ...
    category: 'Eye area',
    desc: 'Delikatne zagęszczenie i nawilżenie cienkiej skóry pod oczami.',
    details: 'Rozświetlenie spojrzenia oraz poprawa jakości skóry bez sztucznego efektu.',
    duration: '30–45 min',
    effect: 'Fresh look',
  ...
  },
  {
    ...
    title: 'Electri',
    category: 'Eye area',
    desc: 'Biorewitalizacja okolicy oka i poprawa elastyczności skóry.',
    details: 'Naturalne odświeżenie spojrzenia i poprawa tekstury delikatnej skóry.',
    duration: '30–45 min',
    effect: 'Skin quality',
  ...
  },
  {
    ...
    category: 'Eye area',
    desc: 'Wsparcie jakości skóry oraz subtelne wygładzenie okolicy oka.',
    details: 'Świeży, wypoczęty wygląd oraz poprawa nawilżenia skóry.',
    duration: '30–45 min',
    effect: 'Smooth skin',
  ...
  },
  {
    ...
    desc: 'Poprawa gęstości i elastyczności skóry twarzy, szyi i dekoltu.',
    details: 'Subtelne ujędrnienie i regeneracja bez dodawania objętości.',
    duration: '45 min',
    effect: 'Firmness',
  ...
  },
  {
    ...
    desc: 'Intensywne nawilżenie i zagęszczenie skóry z efektem glow.',
    details: 'Naturalny efekt glass skin i poprawa jakości skóry.',
    duration: '45 min',
    effect: 'Glass skin',
  ...
  },
  {
    ...
    desc: 'Wsparcie sprężystości skóry i poprawa konturów twarzy.',
    details: 'Widoczne odświeżenie oraz poprawa napięcia skóry.',
    duration: '45 min',
    effect: 'Elasticity',
  ...
  },
  {
    ...
    category: 'Hydration',
    desc: 'Silne nawilżenie i wygładzenie skóry z efektem świeżości.',
    details: 'Komfortowy zabieg poprawiający kondycję oraz wygląd skóry.',
    duration: '45 min',
  ...
  },
  {
    ...
    category: 'Hair',
    desc: 'Wspomaganie kondycji skóry głowy i włosów.',
    details: 'Peptydowa terapia wspierająca zdrowie cebulek i jakość włosów.',
    duration: '45 min',
    effect: 'Hair support',
  ...
  },
  {
    ...
    category: 'Skin glow',
    desc: 'Nawilżenie, odżywienie i poprawa jakości skóry.',
    details: 'Dobór terapii indywidualnie do potrzeb skóry twarzy, szyi i dekoltu.',
    duration: '45–60 min',
    effect: 'Glow effect',
...
export default function OfferClient({ faqItems }: OfferClientProps) {
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
            {TREATMENTS.map((treatment, index) => {
              ...
              >
                ...
                <div className="p-7">
                  <p className="leading-7 text-gray-600">{treatment.desc}</p>
