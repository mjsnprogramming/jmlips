...
type Category = "All" | "Lips" | "Face" | "Skin";
...
const CATEGORIES: Category[] = ["All", "Lips", "Face", "Skin"];

const GALLERY_ITEMS: GalleryItem[] = [
    { id: "g1", src: "/portfolio/lips_01.jpg", alt: "Soft lips augmentation", category: "Lips", w: 900, h: 1200 },
  { id: "g2", src: "/portfolio/face_01.jpg", alt: "Cheek contouring", category: "Face", w: 900, h: 1200 },
  { id: "g3", src: "/portfolio/skin_01.jpg", alt: "Skin rejuvenation glow", category: "Skin", w: 900, h: 1200 },
  { id: "g4", src: "/portfolio/lips_02.jpg", alt: "Lip shaping — natural", category: "Lips", w: 900, h: 1200 },
  { id: "g5", src: "/portfolio/face_02.jpg", alt: "Jawline refinement", category: "Face", w: 900, h: 1200 },
  { id: "g6", src: "/portfolio/skin_02.jpg", alt: "Texture smoothing", category: "Skin", w: 900, h: 1200 },
];
...
export default function Portfolio() {
    ...
    const filtered = useMemo(
        () => (active === "All" ? GALLERY_ITEMS : GALLERY_ITEMS.filter(i => i.category === active)), [active]
    );

    return (
        <main className = "bg-[#f7f5f0] min-h-screen">
            <section className = "w-full px-6 md:px-116 lg:px-24 pt-16 pb-10">
          ...
          otwórz zdjęcie, aby powiększyć, a w sekcji niżej sprawdź interaktywne ujęcia&nbsp;Before/After.
                </p>
            </section>
            <section className = "px-6 md:px-16 lg:px-24">
                <div className = "flex flex-wrap gap-3">
                    {CATEGORIES.map(cat => {
                        ...
                        return (
                            <button key = {cat} onClick = {() => setActive(cat)} className = {`px-4 py-2 rounded-full text-sm md:text-base transition
                                ${activeButton ? "bg-[#a67c52] text-white shadow" : "bg-white text-gray-800 border border-[#e7dfd6] hover:bg-[#f0eae2]"}`}
            ...
            <section className = "px-6 md:px-16 lg:px-24 py-10">
                <div className = "px-6 md:px-16 lg:px-24 py-10">
                    {filtered.map(item => (
                        <figure key = {item.id} className = "group relative bg-white rounded-2xl overflow-hidden shadow hover:shadow-lg transition">
                            <Image src = {item.src}alt = { item.alt } width={item.w ?? 1200}
                height={item.h ?? 1600}
...
<section className="px-6 md:px-16 lg:px-24 py-6">
        <h2 className="text-[28px] md:text-[34px] font-serif font-semibold">Before / After</h2>
      ...
      <div className="relative max-w-5xl w-full" onClick={e => e.stopPropagation()}>
        ...
        <div className="bg-white rounded-2xl overflow-hidden shadow-2xl">
          ...
          <div className="p-4 md:p-6">
            <div className="text-sm uppercase tracking-wide text-[#a67c52]">{item.category}</div>
